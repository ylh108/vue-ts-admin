<template>
    <div>
        <div class="map">
            <div id="province" style="height: 100%;"></div>
        </div>
    </div>
</template>
...
export default class Province extends Vue {
    ...
    async getData () {
        let map = await require('@/assets/json/hunan.json') // 本地引用,文字居中
        echarts.registerMap('湖南', map)
        let id: any = document.getElementById('province')
